                  ...
                  <tr key={b.id} className="hover:bg-bone/60 dark:hover:bg-white/5">
                    ...
                    <td className="p-3">
                      <button
                        ...
                        className={`font-mono px-2 py-1 rounded-sm text-[10px] font-bold border uppercase tracking-wide ${
                          b.identity_verified
                    ...
                    <td className="p-3 text-right">
                      <select
                        ...
                        className="bg-bone dark:bg-[#12171b] border-2 border-ink/15 dark:border-white/15 rounded-md px-2 py-1 text-xs text-ink dark:text-white focus:outline-none focus:border-ember capitalize"
                      >
