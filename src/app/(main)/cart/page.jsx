...
export default function CartPage() {
  ...
  const dateCls =
    'w-full bg-bone border border-ink/15 rounded-xl px-4 py-2.5 text-sm text-ink focus:outline-none focus:border-ember';

  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      <div>
        <h1 className="font-display font-bold uppercase text-3xl sm:text-4xl text-ink">Keranjang Sewa</h1>
      ...
      {items.length === 0 ? (
        <div className="text-center py-20 bg-white border border-ink/10 rounded-3xl space-y-4">
          ...
          <Link
            href="/gears"
            className="inline-flex items-center gap-2 px-6 py-3 bg-ember text-white font-display font-semibold uppercase tracking-wide text-sm rounded-xl hover:bg-ember-2 transition-all"
          >
            Pilih Alat Outdoor
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white border border-ink/10 rounded-3xl p-6 space-y-4">
              ...
              <div className="p-3 bg-bone rounded-xl border border-ink/10 flex items-center justify-between text-xs">
              ...
              <div className="divide-y divide-ink/10">
                {items.map((item) => (
                  <div key={item.gear.id} className="py-4 flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-2 bg-bone border border-ink/10 rounded-xl p-1">
          ...
          <div className="h-fit sticky top-24">
            <div className="bg-white border border-ink/10 rounded-3xl p-6 space-y-6 shadow-xl shadow-ink/5">
              ...
              <button
                ...
                className="w-full py-3.5 bg-ember hover:bg-ember-2 text-white font-display font-semibold uppercase tracking-wide rounded-xl shadow-lg shadow-ember/25 transition-all flex items-center justify-center gap-2 text-sm"
              >
